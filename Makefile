...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd custom_reg_form && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd custom_reg_form && i18n_tool generate
...
pull_translations:
	find custom_reg_form/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/custom-form-app/custom_reg_form/conf/locale:custom_reg_form/conf/locale
