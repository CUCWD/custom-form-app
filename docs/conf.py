...
"""
custom-form-app documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'custom-form-app',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/CUCWD/custom-form-app",
...
#
# html_title = 'custom-form-app v1.0.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'An example app that can be used as a template for extending the registration form in the Open edX LMS.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'custom_reg_form'),
                os.path.join(root_path, 'custom_reg_form/migrations')])
